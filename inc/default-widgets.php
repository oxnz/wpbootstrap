 ...
 * @since 2.8.0
 */
class NZRComments_Widget extends WP_Widget {

	function __construct() {
		$widget_ops = array('classname' => 'widget_nzrcomments', 'description' => __( 'Your site&#8217;s most recent comments.' ) );
		parent::__construct('nzrecent-comments', __('Recent Comments'), $widget_ops);
		$this->alt_option_name = 'nzrcomments_widget';

		if ( is_active_widget(false, false, $this->id_base) )
			add_action( 'wp_head', array($this, 'nzrcomments_style') );
